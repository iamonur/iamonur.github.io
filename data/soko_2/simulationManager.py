...
class Sim_Nov:
    ...
    def pipeline(self):
        ...
        while(True):
            ...
            modelChecker = self.spinner(map_, goals=1)
            try:
                modelChecker.perform()
            except spinner.spinCompileException:
            ...
            if modelling_success:
                ...
                if modelling_success:
                    ...
                    max_rollout_depth = (len(avatar)-2) ** 2
                    number_of_playouts= (len(avatar)-2) ** 2
                    mcts_time = time.time()
...
games_implemented = [
	[spritePlanner.sokobanPlanner, spinner.SpinClass_Sokoban, player.SokobanClass, "Sokoban"]]
